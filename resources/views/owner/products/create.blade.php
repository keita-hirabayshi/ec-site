<x-app-layout>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    ...
                    @csrf
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="number" id="price" name="price" value="{{ old('name') }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                           </div>
                           <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                        ...
                        <!-- コントローラー側から渡した$imagesを :images とすることで、component側へ渡す事ができる -->
    ...
    <script>
        ...
        images.forEach(image => { // 1つずつ繰り返す
            ...
            const imageId = e.target.dataset.id.replace(imageName + '_','') // 6文字カット  語尾の数字のみ取得
