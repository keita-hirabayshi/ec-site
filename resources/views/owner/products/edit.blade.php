                ...
                <x-flash-message status="session('status')" />
                    ...
                    <form  id="delete_{{$product->id}}" method="post" action="{{ route('owner.products.destroy',['product' => $product->id]) }}">
                        ...
                        <div class="p-2 w-ful flex justify-around mt-32">
                            <a href="#" data-id="{{ $product->id }}" type="submit" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded text-lg">削除する</a>
                        </div>
                    </form>
                </div>
            </div>
