            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="md:flex md:justify-around">
                        ...
                        <div class="md:w-1/2 ml-4">
                            ...
                            <div class="flex justify-around items-center">
                                ...
                                <button class="flex text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded">カートに入れる</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 text-center" >
                        <button type=“button” data-micromodal-trigger="modal-1" href='javascript:;' class="text-white bg-gray-400 border-0 py-2 px-2 focus:outline-none hover:bg-gray-500 rounded">ショップの詳細を見る</button>
                    </div>
                </div>
            </div>
        </div>
